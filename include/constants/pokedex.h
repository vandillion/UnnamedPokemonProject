...
enum {
    ...
    NATIONAL_DEX_JUNGLIDE,
    NATIONAL_DEX_CANOKITE,
    NATIONAL_DEX_PARMI,
    NATIONAL_DEX_PANDARO,
    NATIONAL_DEX_RADPOLE,
    NATIONAL_DEX_FROGIDOKI,
    NATIONAL_DEX_RACCAT,
    NATIONAL_DEX_LUEL,
    NATIONAL_DEX_LUCROW,
    NATIONAL_DEX_BANDITOOK,
    NATIONAL_DEX_BABARK,
    NATIONAL_DEX_STAGMITE,
    NATIONAL_DEX_HUFFLUFF,
    NATIONAL_DEX_POLLULANT,
    NATIONAL_DEX_MIPHISH,
    NATIONAL_DEX_PURRBIRD,
    NATIONAL_DEX_BELLANCO,
    NATIONAL_DEX_SKULLIAN,
    NATIONAL_DEX_SINEASTER,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_N_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_SINEASTER
...
#define HOENN_DEX_COUNT (HOENN_DEX_SINEASTER + 1)
