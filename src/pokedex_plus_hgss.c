...
static void PrintStatsScreen_Abilities(u8 taskId)
{
    ...
    if (gTasks[taskId].data[5] == 0)
    {
        ...
        if (gAbilitiesInfo[ability0].shortDesc != 0)
            PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[ability0].shortDesc, abilities_x, abilities_y + 14);
        else
        ...
        if (ability1 != ABILITY_NONE && ability1 != ability0)
        {
            ...
            if (gAbilitiesInfo[ability1].shortDesc != 0)
                PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[ability1].shortDesc, abilities_x, abilities_y + 44);
            else
    ...
    else //Hidden abilities
    {
        ...
        if (gAbilitiesInfo[abilityHidden].shortDesc != 0)
            PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[abilityHidden].shortDesc, abilities_x, abilities_y + 14);
        else
