...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return FlagGet(FLAG_VISITED_WOODRIDGE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLDALE_TOWN:
        return FlagGet(FLAG_VISITED_IMPERIAL_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_PETALBURG_CITY:
        return FlagGet(FLAG_VISITED_ANIMORA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SLATEPORT_CITY:
        return FlagGet(FLAG_VISITED_CENTRA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MAUVILLE_CITY:
        return FlagGet(FLAG_VISITED_OLSTERN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_WOODRIDGE_TOWN;
