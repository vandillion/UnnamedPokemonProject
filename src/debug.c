    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_VISITED_WOODRIDGE_TOWN) &&
                FlagGet(FLAG_VISITED_IMPERIAL_ISLAND) &&
                ...
                FlagGet(FLAG_VISITED_ANIMORA_CITY) &&
                FlagGet(FLAG_VISITED_CENTRA_CITY) &&
                FlagGet(FLAG_VISITED_OLSTERN_CITY) &&
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    if (FlagGet(FLAG_LANDMARK_BATTLE_FRONTIER))
    {
        ...
        FlagClear(FLAG_VISITED_IMPERIAL_ISLAND);
        ...
        FlagClear(FLAG_VISITED_ANIMORA_CITY);
        FlagClear(FLAG_VISITED_CENTRA_CITY);
        FlagClear(FLAG_VISITED_OLSTERN_CITY);
    ...
    else
    {
        ...
        FlagSet(FLAG_VISITED_IMPERIAL_ISLAND);
        FlagSet(FLAG_VISITED_DEWFORD_TOWN);
        FlagSet(FLAG_VISITED_LAVARIDGE_TOWN);
        FlagSet(FLAG_VISITED_FALLARBOR_TOWN);
        FlagSet(FLAG_VISITED_VERDANTURF_TOWN);
        FlagSet(FLAG_VISITED_PACIFIDLOG_TOWN);
        FlagSet(FLAG_VISITED_ANIMORA_CITY);
        FlagSet(FLAG_VISITED_CENTRA_CITY);
        FlagSet(FLAG_VISITED_OLSTERN_CITY);
