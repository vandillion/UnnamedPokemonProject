static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 49, 18},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 34, 14},
    ...
    [HEAL_LOCATION_WOODRIDGE_TOWN - 1] = {MAP_GROUP(WOODRIDGE_TOWN), MAP_NUM(WOODRIDGE_TOWN), 19, 20},
