static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 47, 18},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 12, 56},
    [HEAL_LOCATION_MAUVILLE_CITY - 1] = {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 42, 23},
    ...
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 34, 19},
    ...
    [HEAL_LOCATION_WOODRIDGE_TOWN - 1] = {MAP_GROUP(WOODRIDGE_TOWN), MAP_NUM(WOODRIDGE_TOWN), 20, 16},
    [HEAL_LOCATION_WOODRIDGE_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(WOODRIDGE_TOWN_PLAYERS_HOUSE2F), MAP_NUM(WOODRIDGE_TOWN_PLAYERS_HOUSE2F), 1, 4},
    [HEAL_LOCATION_ROUTE134 - 1] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), 23, 6},
    [HEAL_LOCATION_ROUTE132 - 1] = {MAP_GROUP(ROUTE132), MAP_NUM(ROUTE132), 19, 17},
    [HEAL_LOCATION_ROUTE131 - 1] = {MAP_GROUP(ROUTE131), MAP_NUM(ROUTE131), 27, 23},
};
