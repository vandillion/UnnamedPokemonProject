...
static const u8 sText_WildPkmnAppearedPause[] = _("You encountered a wild {B_OPPONENT_MON1_NAME}!{PAUSE 30}{PLAY_SE SE_SELECT}");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("Jonesy used {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_VICTORY_WILD}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_VICTORY_WILD}{PAUSE 60}"),
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("Alright, the Pokémon's HP is low! It's time to throw a Ball!"),
...
const u8 gText_BattleMenu2[] = _("Battle{CLEAR_TO 56}Bag\nPokémon{CLEAR_TO 56}{B_BUTTON} Run");
