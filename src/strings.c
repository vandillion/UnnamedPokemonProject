...
const u8 gText_BirchInTrouble[] = _("Get ready for our very first battle!\nChoose a Pokémon to battle with!");
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 7}2, and{PAUSE 7}… {PAUSE 7}… {PAUSE 7}… {PAUSE 7}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nMet: {DYNAMIC 4}, {LV_2}{DYNAMIC 3}");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nHatched: {DYNAMIC 4}");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nObtained in a trade");
const u8 gText_XNatureFatefulEncounter[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nFateful encounter at {LV_2}{DYNAMIC 3}");
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nMet: {DYNAMIC 4}, {LV_2}{DYNAMIC 3}?");
const u8 gText_XNature[] = _("{DYNAMIC 2}{DYNAMIC 5} nature");
const u8 gText_XNatureMetSomewhereAt[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nMet at {LV_2}{DYNAMIC 3}");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{DYNAMIC 2}{DYNAMIC 5} nature\nHatched");
...
//const u8 gText_WildBattleBFunc[] = _("{FONT_NARROWER}Wild Battle {B_BUTTON} Func.");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 16}1, {PAUSE 7}2, and {PAUSE 7}… {PAUSE 7}… {PAUSE 7}… {PAUSE 7}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");
