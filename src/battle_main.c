...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_LEADER] = { _("Captain"), 20, BALL_ULTRA },
    ...
    [TRAINER_CLASS_GENTLEMAN] = { _("Gentrleman"), 20, BALL_LUXURY },
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = { _("Subzero Czar"), 20, BALL_ULTRA },
